...
/**
 */
namespace Components\Clarity\Console\Vendor;

use Components\Clarity\Console\Brood;
use Components\Clarity\Util\Composer\Builder as Composer;
...
class NewCommand extends Brood
{
     ...
     *
     * @param  \Components\Clarity\Util\Composer\Builder $composer
     * @return \Components\Clarity\Util\Composer\Builder
     */
